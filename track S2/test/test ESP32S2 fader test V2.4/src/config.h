...
// --- PARÁMETROS OPERATIVOS ---
const int PWM_MIN_MOTION_THRESHOLD = 700;     // Mínimo PWM para iniciar movimiento.
// const int PWM_HOLD_VALUE = 638;       // Ahora drive(0) lo hace, no se usa.
const int PWM_MAX_USABLE_DRIVE = 800;

// Valores iniciales sugeridos:
const float DEFAULT_KP = 0.3;    // Aumentado
const float DEFAULT_KI = 0.1;    // Reducido
const float DEFAULT_KD = 0.1;    // Ligera reducción
...
const int PULSE_DURATION_HIGH_ERROR = 2;    
const int PULSE_DURATION_MEDIUM_ERROR = 1; 
const int PULSE_DURATION_LOW_ERROR = 1;    

// Intervalos de pulso (Ajustar según la duración)
const int PULSE_INTERVAL_HIGH_ERROR = 20;  
const int PULSE_INTERVAL_MEDIUM_ERROR = 40; 
const int PULSE_INTERVAL_LOW_ERROR = 60;    
