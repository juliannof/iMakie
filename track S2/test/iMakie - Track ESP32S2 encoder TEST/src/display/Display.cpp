...
void drawHeaderSprite() {
    ...
    static char headerTextBuffer[10]; 

    snprintf(headerTextBuffer, sizeof(headerTextBuffer), "CH-%d", TrackID);
     // Dibuja la cadena desde el buffer
    header.drawString(headerTextBuffer, TFT_WIDTH/2, HEADER_HEIGHT / 2);
