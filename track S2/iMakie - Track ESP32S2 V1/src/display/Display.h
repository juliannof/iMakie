...
// ** ESTADOS DE LOS BOTONES PARA EL DISPLAY **
extern bool recButtonTFTState; // Estado para dibujar el botón REC en la TFT
extern bool soloButtonTFTState;
extern bool muteButtonTFTState;
extern bool selectButtonTFTState;
