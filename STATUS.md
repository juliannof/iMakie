...
### **NEOPIXEL**
- **Estado:** funcional (cambio a Adafruit 3.1.7)
- Secuencia de brillo implementada:
...
- HW_STATUS display en boot: 10 componentes color-coded (2026-04-28 16:15)
...
### **FADER**
- **Estado:** funcional, validación pendiente con hardware real
...
- Ruido actual: ±30 cuentas (fix futuro: ADS1015 pedido, será I2C)

### **FADER TOUCH**
- **Estado:** EN DESARROLLO (perfecto sin plástico, validación pendiente)
...
- Problema resuelto: reset() ahora en post-VPot (antes causaba VPot ring no responda)
