...
#define TFT_RST  6  // RST     Reset pin (could connect to RST pin) -  ew q 
#define TFT_DC   5  // RS  Data Command control pin
#define TFT_BL   7 // LED/BLK LED back-light (required for M5Stack)
#define TFT_CS   8  // CS      Chip select control pin
#define TOUCH_CS -1
