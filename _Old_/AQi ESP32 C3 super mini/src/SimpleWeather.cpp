...
OpenWeather::OpenWeather(String Key, String City){
  ...
  //_City = City;
  _forecast = false;
  _url = "/data/2.5/weather?q=" + City + "&lang=es&appid=" + Key +"&units=metric";
}
...
OpenWeather::OpenWeather(String Key, float lat, float longi){
  ...
  //_City = City;
  _forecast = false;
  _url = "/data/2.5/weather?lat=" + String(lat) + "&long=" + String(longi) + "&lang=es&appid=" + Key +"&units=metric";
}
...
OpenWeather::OpenWeather(String Key, String City, boolean forecast){
  ...
  _forecast = forecast;
  if(!forecast)
    _url = "/data/2.5/weather?q=" + City + "&lang=es&appid=" + Key +"&units=metric&cnt=1";
  else
    _url = "/data/2.5/forecast?q=" + City + "&lang=es&appid=" + Key +"&units=metric&cnt=2";
}
